...
@version 1.0
@type wsrestful
@obs Modelo de desenvolvimento de API Rest em ADVPL
/*/

WSRESTFUL zWsGrpProd DESCRIPTION 'Grupo Produtos'
    //Atributos
    WSDATA id         AS STRING
...
WSMETHOD GET ID WSRECEIVE id WSSERVICE zWsGrpProd
    ...
    Else
        ...
        Else
            ...
            jResponse['dtumov'] := dToS((cAliasWS)->BM_DTUMOV )
        EndIf
    EndIf
...
WSMETHOD GET ALL WSRECEIVE updated_at, limit, page WSSERVICE zWsGrpProd
    ...
    // então você pode substituir o campo 'BM_USERLGA' por S_T_A_M_P_, I_N_S_D_T_ ou outro campo de data da tabela
    If ! Empty(::updated_at)
...
WSMETHOD DELETE ERASE WSRECEIVE id WSSERVICE zWsGrpProd
    ...
    Else
        ...
        Else
            ...
            //Adiciona os dados do ExecAuto
            aAdd(aDados, {'BM_GRUPO',   SBM->BM_GRUPO,   Nil})
            aAdd(aDados, {'BM_DESC',   SBM->BM_DESC,   Nil})
